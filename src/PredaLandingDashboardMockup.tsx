...
function AuthSection() {
  ...
  const handleCreateTestBattle = async () => {
    ...
    console.log("ABOUT TO CALL createBattle");
    ...
    alert(`Battle created! Tx: ${result.tx}`);
  } catch (error) {
...
const handleFetchBattles = async () => {
  console.log("FETCH BUTTON CLICKED");
    ...
    try {
      ...
      const battles = await fetchBattles(wallet);
      console.log("BATTLES FROM CHAIN:", battles);
      alert(`Fetched ${battles.length} battle(s). Check console.`);
    } catch (error) {
      console.error("FETCH BATTLES FAILED:", error);
      alert("Failed to fetch battles. Check console.");
    }
  };
